...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-kou-21.35-kourovka-notebook-problem-21.35-3c095019-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/KOU-21.35"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-kou-21.35-kourovka-notebook-problem-21.35-3c095019-v1",
      "problem_contract_sha256": "ce679760d1fc09905308d85f867032e5476c490577406b77811b1d1c64bbc2cb",
      "problem_id": "problem:um-kou-21.35-kourovka-notebook-problem-21.35-3c095019",
      "route_id": "route:um-kou-21.35-kourovka-notebook-problem-21.35-3c095019-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-kou-21.35-kourovka-notebook-problem-21.35-3c095019-source-fidelity-01",
      "graph_id": "graph:um-kou-21.35-kourovka-notebook-problem-21.35-3c095019-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-kou-21.35-kourovka-notebook-problem-21.35-3c095019-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-kou-21.35-kourovka-notebook-problem-21.35-3c095019-root",
          "statement": {
            "formal_declaration": null,
            "language": "en",
            "text": "Let $G$ be a finite group, $w$ a multilinear commutator group-word, and $p$ a prime. Suppose that $p$ divides the order $|xy|$ whenever $x$ is a $w$-value of $p'$-order in $G$ and $y$ is a $w$-value in $G$ of order divisible by $p$. Is it true that then the verbal subgroup $w(G)$ must be $p$-nilpotent?"
          },
          "statement_sha256": "fce394bec1e0759fe279d920cdcbd2afdc95ecee3f092cb832eb8319567acf37"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-kou-21.35-kourovka-notebook-problem-21.35-3c095019-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-kou-21.35-kourovka-notebook-problem-21.35-3c095019-root",
      "route_id": "route:um-kou-21.35-kourovka-notebook-problem-21.35-3c095019-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-kou-21.35-9a4c81d85a30",
        "url": "https://www.unsolvedmath.com/problems/KOU-21.35"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
